client: client-main.o icmp.o checksum.o
	gcc -o client client-main.o icmp.o checksum.o

server: server-main.o stun.o icmp.o checksum.o
	gcc -o server server-main.o stun.o icmp.o checksum.o
